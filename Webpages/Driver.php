...
<body>
    <div class="more-infor">
        <div class="sign"><br>
            ...
            <form auto_complete="off" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post"
                ...
                <div class="form_group">
                    <input type="file" name="image" id="file" class="form_field" style="display: none;">
                    <label for="file" class="button" style="background-color: darkseagreen;">Upload Profile</label>
                </div>
                <br><br>
                                                ...
                                                $function=strlen($password);
                                                    if($password == $cpassword){
                                                        if($function<8){
                                                            ...
                                                            $profile = "INSERT INTO users VALUES('','$user_id','$name','$email','$number','$password','$img_new_name','$drivers')";
