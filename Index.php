        ...
        <div class="nav-bar">
            ...
            <div class="menu" id="menu">
                <div class="logo-toggle">
                    <span class="logo"><a href="#">LOGIISTICS MANAGEMENT SYSTEM. </a></span>
                    <img src="node_modules/bootstrap-icons/icons/x.svg" alt="x" onclick="siderbarClose()">
                </div>
                <ul class="nav-links">
                    <li><a href="Index.php"></a></li>
                    <li><a href="Index.php">Home</a></li>
                    <li><a href="webpages/Transport.php">Transport</a></li>
                    <li><a href="webpages/Register.php">Customer Register</a></li>
                    <li><a href="webpages/Driver.php">Driver Register</a></li>
        ...
        <div class="item-list">
            <div class="list-details">
                ...
                <p>Hence, with this logistic management system, most of these problems are solved. This system was
                    ...
                    different personals to take care of various logistic solutions and is also saves a lot of time.
                </p>
            </div>
            <div class="intro">
